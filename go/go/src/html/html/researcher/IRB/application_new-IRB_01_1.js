function dataMappingFunc(e) {
  0 == e.app_seq &&
    e.addMoreSaveTag("application_info", { data: g_AppInfo.appObj });
  var a = "general_title";
...
function setDate() {
  ...
  t.setDate(t.getDate() + 1095), $(
    ...
    e.getTime() > l.getTime()
      ...
      : t.getTime() < l.getTime() &&
      (alert("연구 기간은 신청일 기준 3년까지 가능합니다."), $("#general_end_date").val(a));
  });
}
"undefined" == typeof api_js &&
  ...
  document.write(
    "<script src='/assets/js/common/const.js'></script>"
  ), document.write(
    "<script src='/html/researcher/IRB/common_application_new-IRB.js'></script>"
  ), $(document).ready(function () {
    loadApplicationParams(), (g_AppItemParser = new ItemParser(
      g_AppInfo.appSeq
