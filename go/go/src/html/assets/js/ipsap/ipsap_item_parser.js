...
function makeEduCourse(user_seq) {
  ...
  $(`.course_${user_seq}`).children('div').each(function () {
        ...
        if (value.ui_index != undefined) {
          ...
          for (let l = 0; l < value.ui_index.length; ++l) {
            ...
            if (aniData.animal_code == null) {
              ...
              var inputObj = $('#' + getIdWithIdx(`animal_select`, ui_index)).parent().children('input');
            ...
            if (aniData.mb_grade == null) {
              ...
              var inputObj = $('#' + getIdWithIdx(`mb_grade_select`, ui_index)).parent().children('input');
            ...
            if (aniData.breeding_place == null) {
              ...
              var inputObj = $('#' + getIdWithIdx(`breeding_place_select`, ui_index)).parent().children('input');
        ...
        if (1 == getNumberFromBool(chkObj.is(":checked"))) {
          ...
          for (let l = 0; l < value.ui_index.length; ++l) {
            ...
            if (tmpData.anesthetic_type == 'new') {
              ...
              var inputObj = $('#' + getIdWithIdx(anesthetic_type, ui_index)).parent().children('input');
            ...
            if (tmpData.injection_route == 'new') {
              ...
              var inputObj = $('#' + getIdWithIdx(injection_route, ui_index)).parent().children('input');
      ...
      if (old_item_data.itemName == "ibc_general_fclty") {
        ...
        for (let l = 0; l < value.ui_index.length; ++l) {
          ...
          if (tmpData.ibc_general_fclty_type == 'new') {
            ...
            var inputObj = $('#' + getIdWithIdx(ibc_general_fclty_type, ui_index)).parent().children('input');
        ...
        if (value.ui_index != undefined) {
          ...
          for (let l = 0; l < value.ui_index.length; ++l) {
            ...
            if (tmpData.ibc_exposure_path == 'new') {
              ...
              var inputObj = $('#' + getIdWithIdx(ibc_exposure_path, ui_index)).parent().children('input');
  ...
  getSendingObj() {
        ...
        if (value.ui_index != undefined) {
          ...
          for (let l = 0; l < value.ui_index.length; ++l) {
            ...
            if (tmpData.animal_exp_substance_method1 == 'new') {
              ...
              var inputObj = $('#' + getIdWithIdx(animal_exp_substance_method1, ui_index)).parent().children('input');
    ...
    if (old_item_data.itemName == "research_type_check") {
      ...
      if (old_item_data.itemName == "general_object") {
        ...
        strData["0"] = $('input[name="general_object"]:checked').val();
        dataObj["data"] = strData;
      }
