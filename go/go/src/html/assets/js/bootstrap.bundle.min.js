...
!function (t, e) {
  ...
  function n(t) {
    ...
    return (void 0 === n ? t : t.slice(0, function (t, e, n) {
      ...
      t.function && void 0;var n = t.function || t.fn;t.enabled && A(n) && (e.offsets.popper = K(e.offsets.popper), e.offsets.reference = K(e.offsets.reference), e = n(e, t));
    }), e;
  }function ft() {
    ...
    var o = [0, 0],
      ...
      return -1 !== t.search(/,|\s/);
    }));a[s] && -1 === a[s].indexOf(",") && void 0;var l = /\s*,\s*|\s+/,
      ...
      t.forEach(function (n, i) {
        _t(n) && (o[e] += n * ("-" === t[i - 1] ? -1 : 1));
          ...
          } else if (!t.instance.popper.contains(i)) return void 0, t;var o = t.placement.split("-")[0],
              r = t.offsets,
              a = r.popper,
              s = r.reference,
          ...
          }).gpuAcceleration;void 0 !== r && void 0;var a = void 0 !== r ? r : e.gpuAcceleration,
